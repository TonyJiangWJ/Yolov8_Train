from copy_labeled_data import copy_labeled_data
...
if __name__ == '__main__':
    copy_count = 0
    # 新标签数据集
    new_root_path = r'E:/Repository/YOLOV8_train/data/forest_20240625'
    # 旧标签数据集
    old_data_path = 'E:/Repository/YOLOV8_train/data/forest_new'
